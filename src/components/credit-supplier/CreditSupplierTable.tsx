...
import type { CreditSupplier } from '../../types/entities/supplierCredit.types';
...
interface Props {
  data: CreditSupplier[];
  loading: boolean;
  onPay: (supplier: CreditSupplier) => void;
  pagination: {
    page: number;
    limit: number;
    total: number;
...
const CreditSupplierTable: React.FC<Props> = ({
  data,
  loading,
  onPay,
  pagination,
...
export default CreditSupplierTable;
