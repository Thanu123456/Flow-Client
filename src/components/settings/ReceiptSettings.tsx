...
const ReceiptSettings: React.FC<Props> = ({ onDirtyChange }) => {
  const { settings, businessProfile, saving, saveSettings, fetchBusinessProfile } =
    useSettingsStore();
        ...
        <Col xs={24} lg={16} xl={17}>
          <Form form={form} layout="vertical" onValuesChange={handleValuesChange}>
            <FieldGroup title="Paper">
              <Row gutter={[20, 0]}>
                <Col xs={12} sm={6}>
                  <Form.Item name="receiptPaperSize" label="Size">
                    <Select
                      options={[
                ...
                <Col xs={12} sm={6}>
                  <Form.Item
                    ...
                    label="Top margin (mm)"
                    tooltip="Vertical offset before the header — nudge to align with pre-printed paper."
                ...
                <Col xs={12} sm={6}>
                  <Form.Item name="receiptLanguage" label="Language">
                    <Select
                      options={[
              ...
              <Row gutter={[20, 0]}>
                <Col xs={24} md={12}>
                  <Form.Item
                    ...
                    label="Header line"
                    tooltip="Shown under the address — e.g. a tagline or hotline."
                    rules={[{ max: 280 }]}
                  >
                ...
                <Col xs={24} md={12}>
                  <Form.Item name="receiptFooterText" label="Footer line" rules={[{ max: 280 }]}>
                    <Input.TextArea
                      rows={2}
                      maxLength={280}
                      showCount
