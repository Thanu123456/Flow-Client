    ...
    return (
        <div className="min-h-screen overflow-x-hidden bg-white">
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
                ...
                {/* ── Left Panel ── */}
                <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
                    {/* Animated blobs */}
                    ...
                    <div className="relative z-10 space-y-8 w-full">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="relative group cursor-default pt-2 w-full">
